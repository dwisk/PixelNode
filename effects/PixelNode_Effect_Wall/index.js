...
function PixelNode_Effect_Wall(options,pixelData) {
  var self = this;
  PixelNode_Effect_Wall.super_.call(self, options, pixelData);
  this.className = "PixelNode_Effect_Wall";
  self.public_dir = __dirname;
}

// class inheritance 
util.inherits(PixelNode_Effect_Wall, PixelNode_Effect);

// module export
module.exports = PixelNode_Effect_Wall;
...
PixelNode_Effect_Wall.prototype.init = function() {
	console.log("Init Effect Glitter".grey);
}

// draw effect on target
PixelNode_Effect_Wall.prototype.drawTarget = function(target) {
	var self = this;
