...
function PixelNode_Effect_Intensity(options,pixelData) {
  var self = this;
  PixelNode_Effect_Intensity.super_.call(self, options, pixelData);
  self.className = "PixelNode_Effect_Intensity";
  self.public_dir = __dirname;
}

// class inheritance 
util.inherits(PixelNode_Effect_Intensity, PixelNode_Effect);

// module export
module.exports = PixelNode_Effect_Intensity;


/* Variables
 * ==================================================================================================================== */

PixelNode_Effect_Intensity.prototype.n = 1;
...
PixelNode_Effect_Intensity.prototype.init = function() {
	console.log("Init Effect Intensity".grey);
}
...
PixelNode_Effect_Intensity.prototype.drawTarget = function(target, output) {
	...
	for (var ring = 0; ring < target.length;ring++) {
		...
		for (var pixel = 0; pixel < target[ring].length; pixel++) {
			var factor = 1/target[ring].length*pixel;
			target[ring][pixel] = [c1.r*factor, c1.g*factor, c1.b*factor];
		}			    
	}
