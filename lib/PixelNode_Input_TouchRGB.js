...
// extending Effect
PixelNode_Input = require('./PixelNode_Input.js');
...
PixelNode_Input_TouchRGB.prototype.init = function() {
	...
	var Effect_Color = require("./PixelNode_Effect_Color");
...
PixelNode_Input_TouchRGB.prototype.reader = function() {
	...
	if (self.colorSelect) {		
		...
		for (var i = 0; i < newTouches.length; i++) {
			if (newTouches[i]) {
				tc = new HSVColour(i*30, 100, 100).getRGB();
