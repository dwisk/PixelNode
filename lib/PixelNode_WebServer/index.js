...
PixelNode_WebServer.prototype.index = function(req, res){
  res.render('index', {options: req.app.locals.options});
};

PixelNode_WebServer.prototype.simulator = function(req, res){
  res.render('simulator/view', {options: req.app.locals.options});
};
