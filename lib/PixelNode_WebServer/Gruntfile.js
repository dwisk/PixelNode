module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      libs_css: {
        src: [
          'build/libs/slick-carousel/slick/slick.css',
          'build/libs/slick-carousel/slick/slick-theme.css'
        ],
      ...
      libs: {
        src: [
          //'build/libs/jquery/dist/*.js',
          //'build/slick-carousel/slick/slick.js',
          'build/libs/angular/*.js',
          'build/libs/angular-socket-io/*.js',
          //'build/libs/angular-slick/dist/slick.js'
        ],
