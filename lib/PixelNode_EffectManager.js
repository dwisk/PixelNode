...
PixelNode_EffectManager.prototype.overrideEffect = null;
...
PixelNode_EffectManager.prototype.wasOverride = false;
...
PixelNode_EffectManager.prototype.drawEffect = function() {
	...
	// draw effects
		...
		// draw override effect
		if (global.pixelNode_data.overrideEffect) {
			this.getEffectByName(global.pixelNode_data.overrideEffect).draw();			
