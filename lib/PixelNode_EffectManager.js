...
PixelNode_EffectManager.prototype.setEffectByQueueId = function(id) {
	...
	this.queueId = id;
	global.pixelNode_data.effects.queueId = id;
};
...
PixelNode_EffectManager.prototype.initObserver = function() {
	...
	Object.observe(global.pixelNode_data, function(changes) {
		if (global.pixelNode_data.effects.queueId != self.queueId) {
			self.setEffectByQueueId(global.pixelNode_data.effects.queueId);	
			global.pixelNode_data.effects.autoplay = false;
		}
