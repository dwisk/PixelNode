...
const PixelNode_InputManager = require("./PixelNode_InputManager.js");
const PixelNode_FontManager = require("./PixelNode_FontManager.js");
const PixelNode_Sound = require("./PixelNode_Sound.js");
...
class PixelNode extends EventEmitter {
	...
	* ---------------------------------------------------------------------------------------------------------------- */
	...
	constructor(options) {
		...
		global.PixelNode = this.constructor;
		var self = this;
		...
		* ---------------------------------------------------------------------------------------------------------------- */
		...
		global.config.pixelDrivers.forEach(function(pixelDriverConfig) {
			const PixelDriver = PixelNode.getOption(pixelDriverConfig.module);
