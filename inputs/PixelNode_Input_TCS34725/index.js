...
function PixelNode_Input_TCS34725(options,pixelData) {
  var self = this;
  PixelNode_Input_TCS34725.super_.call(self, options, pixelData);
  this.className = "PixelNode_Input_TCS34725";
}

// class inheritance 
util.inherits(PixelNode_Input_TCS34725, PixelNode_Input);

// module export
module.exports = PixelNode_Input_TCS34725;


/* Variables
 * ==================================================================================================================== */

PixelNode_Input_TCS34725.prototype.default_options = {
	"sensors": [
		{
			"name"	  : "color_left",
		    "bus"     : "/dev/i2c-2", 
...
PixelNode_Input_TCS34725.prototype.gammatable = [];
...
PixelNode_Input_TCS34725.prototype.init = function() {
	var self = this;
...
// init sensors
PixelNode_Input_TCS34725.prototype.initSensors = function() {
	var self = this;
...
PixelNode_Input_TCS34725.prototype.initGammaTable = function() {
...
PixelNode_Input_TCS34725.prototype.getRGBcolor = function(sensor, cb) {
	var self = this;
  var ledON = false;
  var readings = 0;
  var red = 0;
...
PixelNode_Input_TCS34725.prototype.startReading = function() {
	var self = this;
